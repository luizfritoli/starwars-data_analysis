...
correl_no_outlier = ggcorrplot(correl_filt,
           lab=TRUE,
           lab_size = 3.5)

correl_outlier = ggcorrplot(correl,
           lab=TRUE,
           lab_size = 3.5)

ggsave(
  filename = "../assets/correl_no_outlier.png",
  plot = correl_no_outlier,
  width = 8,
  height = 5,
  dpi = 300
)
...
ggsave(
  filename = "../assets/correl_outlier.png",
  plot = correl_outlier,
  width = 8,
  height = 5,
  dpi = 300
...
ggsave(
  filename = "../assets/disp_outlier.png",
  plot = disp_outlier,
  width = 10,
  height = 5,
  dpi = 300
...
ggsave(
  filename = "../assets/disp_no_outlier.png",
  plot = disp_no_outlier,
  width = 10,
  height = 5,
  dpi = 300
)
...
ggsave(
  filename = "../assets/proporcao_genero.png",
  plot = proporcao_genero,
  width = 9,
  height = 5,
  dpi = 300
)
...
freq_origem_coluna = dados_resumidos %>%
...
ggsave(
  filename = "../assets/freq_origem_coluna.png",
  plot = freq_origem_coluna,
  width = 9,
  height = 5,
  dpi = 300
)
...
freq_especies_barra = especies_resumido %>%
...
ggsave(
  filename = "../assets/freq_especies_barra.png",
  plot = freq_especies_barra,
  width = 9,
  height = 5,
  dpi = 300
)
